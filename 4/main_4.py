...
class MemoryOptimizer:
    ...
    def compare_profiles(self, unoptimized_data, optimized_data):
        ...
        plt.tight_layout()
        plt.savefig('example4_profile_comparison.png')
        plt.close()
        print("Profile comparison graph saved as 'example4_profile_comparison.png'.")
...
if __name__ == "__main__":
    main(
        csv_path_unoptimized="example4_output.csv",
        cpp_source_path="growing_ds.cpp",
        output_cpp_path="optimized_growing_ds.cpp",
        output_csv_optimized="optimized_example4_output.csv"
    )
