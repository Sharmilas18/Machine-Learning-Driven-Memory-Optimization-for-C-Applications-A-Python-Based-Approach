...
class MemoryOptimizer:
    ...
    def compare_profiles(self, unoptimized_data, optimized_data):
        ...
        plt.tight_layout()
        plt.savefig('example6_profile_comparison.png')
        plt.close()
        print("Profile comparison graph saved as 'example6_profile_comparison.png'.")
...
if __name__ == "__main__":
    main(
        csv_path_unoptimized="example6_output.csv",
        cpp_source_path="recursive.cpp",
        output_cpp_path="optimized_recursive.cpp",
        output_csv_optimized="optimized_example6_output.csv"
    )
