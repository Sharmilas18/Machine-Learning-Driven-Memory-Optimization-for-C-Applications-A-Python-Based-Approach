...
class MemoryOptimizer:
    ...
    def compare_profiles(self, unoptimized_data, optimized_data):
        ...
        plt.tight_layout()
        plt.savefig('example2_profile_comparison.png')
        plt.close()
        print("Profile comparison graph saved as 'example2_profile_comparison.png'.")
...
if __name__ == "__main__":
    main(
        csv_path_unoptimized="example2_output.csv",
        cpp_source_path="mem_fragmentation.cpp",
        output_cpp_path="optimized_mem_fragmentation.cpp",
        output_csv_optimized="optimized_example2_output.csv"
    )
