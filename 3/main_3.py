...
class MemoryOptimizer:
    ...
    def compare_profiles(self, unoptimized_data, optimized_data):
        ...
        plt.tight_layout()
        plt.savefig('example3_profile_comparison.png')
        plt.close()
        print("Profile comparison graph saved as 'example3_profile_comparison.png'.")
...
if __name__ == "__main__":
    main(
        csv_path_unoptimized="example3_output.csv",
        cpp_source_path="cache_misses.cpp",
        output_cpp_path="optimized_cache_misses.cpp",
        output_csv_optimized="optimized_example3_output.csv"
    )
